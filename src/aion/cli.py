...
from .repair import IncidentDetector, RepairExecutor, Verifier
from .semgrep_runner import SemgrepRunner, semgrep_available

app = typer.Typer(help="AION: scan Python repos and open verified security auto-fixes.", no_args_is_help=True)
...
@app.callback()
def main() -> None:
    """AION: scan Python repositories and open verified security auto-fixes."""
